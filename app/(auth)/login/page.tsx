      ...
      <div className="hidden lg:flex lg:w-[45%] bg-black flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative">
          <blockquote className="text-white text-2xl font-medium leading-snug tracking-tight mb-6">
            "The more that you read,<br />the more things you will know."
          </blockquote>
          <p className="text-neutral-500 text-sm">— Dr. Seuss</p>
        </div>

        <div className="relative flex items-center gap-2">
          <div className="w-1.5 h-1.5 rounded-full bg-green-400" />
          <p className="text-neutral-500 text-xs">AI-powered study assistant</p>
        </div>
      </div>
